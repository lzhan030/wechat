...
<div class="comments-box"> <a name="comments" id="comments"></a>
  ...
  <div id="respond">
    ...
    <?php else : ?>
    <!--<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php?site=<?php echo $siteId?>&weid=<?php echo $weid?>" method="post" id="commentform" onsubmit="return checkvip()">-->
