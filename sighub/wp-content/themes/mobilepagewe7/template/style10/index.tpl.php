...
.box{width:100%;overflow:hidden;position:fixed; bottom:20px; padding-left:7%;}
.box .box-item{float:left; display:inline-block; width:45%; text-align:center; margin:0 1%; text-decoration:none;outline:none; height:40px; line-height:40px; margin-bottom:5px; color:#FFF; background:rgba(163, 143, 92, 0.7);}
