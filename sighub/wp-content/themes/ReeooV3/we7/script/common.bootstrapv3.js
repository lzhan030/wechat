...
function message(msg, redirect, type) {
	...
	function _message(msg, redirect, type) {
		...
		if(modalobj.length == 0) {
			...
			$('#modal-message').on('hidden.bs.modal',function(){$(this).empty();$(this).removeClass();$(this).addClass('modal hide fade');});
			var modalobj = $('#modal-message');
		}
...
function kindeditor(selector) {
	...
	var option = {
		basePath : './wp-content/themes/ReeooV3/we7/script/kindeditor/',
		themeType : 'simple',
		langType : 'zh_CN',
	...
	if (typeof KindEditor == 'undefined') {
		$.getScript('./wp-content/themes/ReeooV3/we7/script/kindeditor/kindeditor-min.js', function(){initKindeditor(selector, option)});
	} else {
...
function kindeditorUploadBtn(obj, callback) {
	if (typeof KindEditor == 'undefined') {
		$.getScript('./wp-content/themes/ReeooV3/we7/script/kindeditor/kindeditor-min.js', initUploader);
	} else {
		initUploader();
	}
