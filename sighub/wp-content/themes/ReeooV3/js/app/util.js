	...
	module.image = function(val, callback, opts) {
		var content = 	'<div class = "tab-content form-horizontal" style="padding:20px 0;">'+
							'<div class="form-group tab-pane active" id="image_upload">'+
								...
								'<form action="./index.php?c=utility&a=file&do=upload&type=image&callback=uploaderImageComplete&i='+window.sysinfo.uniacid+'" enctype="multipart/form-data" method="post" target="__image_file_uploader">'+
									'<div class="form-group">' +
										'<div class="col-sm-12">' +
