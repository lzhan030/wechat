...
<?php
	...
	$site_postpermission = web_admin_get_site_resource($siteId, "mobilethemeIsPostPermission","false");
	$site_needapproval = web_admin_get_site_resource($siteId, "mobilethemeNeedApproval","false");
	...
	$qiniu_access = web_admin_get_site_resource($siteId, "qiniu_access","");
	$qiniu_secret = web_admin_get_site_resource($siteId, "qiniu_secret","");
	$qiniu_bucket = web_admin_get_site_resource($siteId, "qiniu_bucket","");
...
<div id="primary" class="site-content">
	<div id="content" role="main">
		...
		<form action="<?php echo constant("CONF_THEME_DIR"); ?>/wesite/mobilevideotheme/post_list.php?beIframe<?php if(isset($_GET['isupdate'])){echo "&isupdate";} ?>&siteId=<?php echo $siteId ?>" method="post" enctype="multipart/form-data">		
			<div>
				...
				<div><!--表单-->
					<table width="700" height="350" border="0" style=" margin-left:100px; margin-top:10px;">
						...
						<tr>
							<td width="300" height="50"><b><font color="red">*</font> 七牛云存储accessKey</b>
									<input name='qiniu_access' class="form-control" size='30' type='text' id='qiniu_access' value='<?php echo $qiniu_access ?>' maxlength='50' /> 
							</td>	
						</tr>
						<tr>
							<td width="300" height="50"><b><font color="red">*</font> 七牛云存储secretKey</b>
									<input name='qiniu_secret' class="form-control" size='30' type='text' id='qiniu_secret' value='<?php echo $qiniu_secret ?>' maxlength='50' /> 
							</td>	
						</tr>	
						<tr>
							<td width="300" height="50"><b><font color="red">*</font> 七牛云存储bucket</b>
									<input name='qiniu_bucket' class="form-control" size='30' type='text' id='qiniu_bucket' value='<?php echo $qiniu_bucket ?>' maxlength='50' /> 
							</td>	
						</tr>	
						<tr>
							...
							<div><center>
								<table border="0" cellspacing="10" cellpadding="0" style="margin-left:120px;">
									...
									<tr>
										<td width="200" style="<?php if($selCheck['wechatvip']!=1) echo ' display:none'; ?>">
											<label class="checkbox">
												<input type="checkbox" name='post_permission' id='post_permission' value='true' <?php if($site_postpermission == "true") {echo "checked";} ?>> 
												允许会员上传视频
											</label>
										</td>
										<td width="170" style="<?php if($selCheck['wechatvip']!=1) echo ' display:none'; ?>">
											<label class="checkbox">
												<input type="checkbox" name='theme_needapproval' id='theme_needapproval' value='true' <?php if($site_needapproval == "true") {echo "checked";} ?>> 
												用户上传视频需要审核
											</label>
										</td>
									</tr>								
