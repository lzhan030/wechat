		...
		<form action="" method="post">
			<div>
				<div class="main-title">
					<div class="title-1">当前位置：微官网 >视频><font class="fontpurple"><?php echo "视频评论" ?>  </font>   
					</div>
				</div>
				<div class="bgimg"></div>
				...
				<div style="margin-left:20px;">
					...
					<div class="panel panel-default" style="margin-right:50px; margin-top:30px">
						<div class="panel-heading" >视频评论列表</div>
...
<script language='javascript'>
	...
	function deleteComment(ID){	   
		if(confirm("确定删除吗？")){
			...
			xmlHttp.open("GET","<?php echo constant("CONF_THEME_DIR"); ?>/wesite/mobilevideotheme/comment_delete.php?beIframe&commentid="+ID,true);
