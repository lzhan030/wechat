...
?>
	...
	if($postid==null){
		if($addAttachment == "true") {
			...
			$insert_postid=web_admin_create_post($post_title, $_POST['video_pkey'],$siteId,$artType);
		}
		else {
			$insert_postid=web_admin_create_post($post_title, $_POST['video_pkey'],$siteId,$artType);
...
<script language='javascript'>
	function closeit() {
		...
		opener.location.href = "<?php echo bloginfo('template_directory')?>/wesite/mobilevideotheme/post_list.php?beIframe&siteId="+"<?php echo $siteId;?>";
	}
