...
<div id="primary" class="site-content">
	<div id="content" role="main">
		...
		<form action="<?php echo constant("CONF_THEME_DIR"); ?>/wesite/mobiletheme/post_list.php?beIframe<?php if(isset($_GET['isupdate'])){echo "&isupdate";} ?>&siteId=<?php echo $siteId ?>" method="post" enctype="multipart/form-data">		
			<div>
