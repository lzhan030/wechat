...
<div id="primary" class="site-content">
	<div id="content" role="main">
		...
		<form action="<?php echo constant("CONF_THEME_DIR"); ?>/wesite/videotheme/post_list.php?beIframe<?php if(isset($_GET['isupdate'])){echo "&isupdate";} ?>&siteId=<?php echo $siteId ?>" method="post" enctype="multipart/form-data">		
			<div>
				...
				<div><!--表单-->
					<table width="700" height="350" border="0" style=" margin-left:100px; margin-top:10px;">
						...
						<tr>
							<td width="300" height="50"><b><font color="red">*</font> 主题颜色</b>
							...
							<div><center>
								<table border="0" cellspacing="10" cellpadding="0" style="margin-left:180px;">
									<tr>
										...
										<td>
											<table ID=ColorTable BORDER=0 CELLSPACING=0 CELLPADDING=0 style='cursor:pointer; margin-left:50px;' onMouseOut="ColorTableonmouseout()"  onMouseOver="ColorTableonmouseover()" onClick="ColorTableonclick()">
