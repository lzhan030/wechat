...
<div class="dlg-panel panel panel-default" style="border-color: #FFF;">
  <div class="panel-heading">
	...
	<form role="form" name ="content" onSubmit="return validateform()" action="<?php echo constant("CONF_THEME_DIR"); ?>/wesite/mobilepagewe7/menu_insert.php?beIframe&siteId=<?php echo $siteId ?>" method="post" enctype="multipart/form-data"> 
		<table width="600" bordercolor="#06c" border="0" align="center" cellpadding="10" cellspacing="0" style="margin-top:25px;font-size:14px;">
			<tr>	
				<td>
			...
			<tr <?php echo ($template -> menu_bg == '0')?'style="display:none;"':''; ?>>	
				<td>
					...
					<input type="text" class="span3" id="menubgcolor" name="icon[menubgcolor]" value="#ffffff" />
					<input class="colorpicker" target="menubgcolor" value="#ffffff" />
				</td>
			</tr>			
			<tr <?php echo ($template -> image_icon == '0')?'style="display:none;"':''; ?>>	
				<td><label for="pic">上传菜单图片：</label>
			...
			<tr <?php echo ($template -> image_icon == '0')?'style="display:none;"':''; ?>>	
				<td>
					<?php if($template -> name == 'style7'){
				?>
					<img id="pic" src="#" alt="图片预览" height='90' width='140'/>
				<?php }else{ ?>
			...
			<tr <?php echo ($template -> image_icon == '0')?'style="display:none;"':''; ?>>	
				<td>
					...
					<input type="text" class="span3" id="iconcolor" name="icon[color]" value="#ffffff" />
					<input class="colorpicker" target="iconcolor" value="#ffffff" />
					<span class="help-block">图标颜色，上传图片时此设置项无效</span>
				</td>
			</tr>
			<tr <?php echo ($template -> image_icon == '0')?'style="display:none;"':''; ?>>	
				<td>
					<label for="name">图标大小</label>
					<input class="span2" type="text" name="icon[size]" id="icon" value="35"><span class="help-inline">PX</span>
					<span class="help-block">图标的尺寸大小，单位为像素，上传图片时此设置项无效</span>
				</td>
			</tr>
			...
			<tr>	
				<td>
					...
					<div class="input-line">
						<div style="<?php if( !$wechatactivity_vip ) echo " display:none"; ?>">
						<input type="radio" name="menuUrl" value="4" onclick="disable()">
						<span> 会员注册</span>
						<input style="visibility:hidden" type="text" name="memregUrl" id="memregUrl" value="<?php bloginfo('template_directory'); ?>/wesite/common/vip_register.php" disabled="disabled"/>
						</div>
					</div>
					<div class="input-line">
						<div style="<?php if( !$wechatactivity_vip ) echo " display:none"; ?>">
						...
						<span> 会员中心</span>
						<input style="visibility:hidden" type="text" name="memUrl" id="memUrl" value="<?php bloginfo('template_directory'); ?>/wesite/common/vip_detail.php" disabled="disabled"/>
						</div>
					</div>
					<div class="input-line">
						<div style="<?php if( !$wechatschool ) echo " display:none"; ?>">
						<input type="radio" name="menuUrl" value="3" onclick="disable()">
						<span> 微学校</span>
						<input style="visibility:hidden" type="text" name="memwsUrl" id="memwsUrl" value="<?php echo home_url(); ?>/mobile.php?module=weSchool&do=index" disabled="disabled"/>
						</div>
					</div>
					<hr/>	
				</td>
