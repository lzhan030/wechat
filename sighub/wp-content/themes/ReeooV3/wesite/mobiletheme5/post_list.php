				...
				<div>
					...
					<div class="panel panel-default" style="margin-right:50px; margin-top:30px">
						...
						//		$numAL = mysql_num_rows($site_list);  //取得记录总数$rs
							...
							<a href="#" onclick="javascript:window.open('<?php echo get_template_directory_uri(); ?>/wesite/mobiletheme5/comment_manage.php?beIframe&postid=<?php echo $mobile_item->ID ?>','_blank','height=520,width=800,top=120,left=240,toolbar=no,menubar=no,scrollbars=yes,resizable=no,location=no,status=no,titlebar=no')">
...
<script language='javascript'>
	...
	function deletePost(ID){	   
		if(confirm("确定删除吗？")){
			...
			xmlHttp.open("GET","<?php echo constant("CONF_THEME_DIR"); ?>/wesite/mobiletheme5/post_delete.php?beIframe&postid="+ID,true);
