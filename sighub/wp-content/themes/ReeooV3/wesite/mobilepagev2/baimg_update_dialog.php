	...
	<body>
		<div id="primary" class="site-content">
			<div id="content" role="main" style="margin: 50px 0 0 30px; width:80%;">
				<form role="form" name="uploadimg" onSubmit="return validateform()" action="<?php echo constant("CONF_THEME_DIR"); ?>/wesite/mobilepagev2/baimg_update.php?beIframe&siteId=<?php echo $siteId?>" method="post" enctype="multipart/form-data"> 
