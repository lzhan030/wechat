...
<script language="javascript">
	...
	{
	  if (checknull(document.uploadimg.file, "请先上传LOGO图片!") == true) {
		return false;
	  }
	  return true; 
	}
	...
	<body>
		<div id="primary" class="site-content">
			<div id="content" role="main" style="margin: 50px 0 0 30px; width:80%;">
				<form role="form" name="uploadimg" onSubmit="return validateform()" action="<?php echo constant("CONF_THEME_DIR"); ?>/wesite/mobilepagev2/logo_update.php?beIframe&siteId=<?php echo $siteId?>" method="post" enctype="multipart/form-data"> 
					<div class="form-group">
						<label for='pic' style='font-size:16px;margin-bottom:30px;'>请上传新LOGO图片：</label>
						（建议上传图片大小为140*120）
