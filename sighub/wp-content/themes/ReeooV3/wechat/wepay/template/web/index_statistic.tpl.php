...
<div class="main_auto">
	<div class="main-title">
		<div class="title-1">当前位置：微支付 &gt; <font class="fontpurple">统计图表 </font>
		</div>
	</div>
	<div style="margin-top:50px;">
		<article>				
			<section class="post-1301 post type-post status-publish format-standard sticky hentry">
				<article class="thumb">
				<a href="<?php echo $this->createWebUrl('orderstatistic',array('gweid' => $gweid));?>" class="button button-circle button-flat-action"><span class="glyphicon glyphicon-check"></span>&nbsp订单统计</a>
				</article>
			</section>
			<section class="post-1301 post type-post status-publish format-standard sticky hentry">
				<article class="thumb">
					<a href="<?php echo $this->createWebUrl('orderstatisticclick',array('gweid' => $gweid));?>" class="button button-circle button-flat-highlight"><span class="glyphicon glyphicon-tasks"></span>&nbsp流量统计</a>
				</article>
			</section>
		</article>
	</div>
