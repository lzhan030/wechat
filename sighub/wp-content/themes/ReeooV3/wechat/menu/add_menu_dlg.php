	...
	<body>
		<div id="primary" class="site-content">
			<div id="content" role="main" style="margin: 50px 0 0 80px; width:80%;">
				<form role="form" name="addmenu" onSubmit="return validateform()" action="<?php echo constant("CONF_THEME_DIR"); ?>/wechat/menu/menu_add.php?&parId=<?php echo $menuId;?>" method="post" enctype="multipart/form-data"> 
