...
<html>
	...
	<div style="padding:0 30px">
				...
				<!--<div class="panel-body">
					...
					<div class="main_bd">
						<div class="left nub0" >
							...
							<!--<input class="getData btn btn-sm btn-info" type="button" value="使用" style="margin:5px 3px 5px 10px;"/>-->
			...
			for(var i=0; i<aCheckBox.length; i++){
				if(aCheckBox[i].getAttribute('type')=='radio'){
					if(aCheckBox[i].checked==true){
						...
						opener.location.href='<?php echo get_template_directory_uri(); ?>/wechat/nokeyword/nokeyword.php?beIframe&isselcet=1&tab=1&newsid='+nid;	
						m=m+1;
						window.close();	
					}
				}
		...
		function editMaterial(nid)
		{
			...
			window.location.href=url+'/wechat/nokeyword/nokeyword_image_select.php?beIframe&artType=post';
		}
		...
		function createNews(){	   
			...
			window.location.href=url+'/wechat/nokeyword/nokeyword_image_select.php?beIframe';
	...
	<?php
		...
		$(".getData").click(function(){
			...
			location.href="<?php bloginfo('template_directory'); ?>/wechat/nokeyword/nokeyword_image_insert.php?beIframe&netId="+nid;
