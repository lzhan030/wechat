...
<html>
					...
					<div class="tab-pane" id="txtTab">				
						<div class="nub-1">
							<table>
								...
								<tr>
									<td>
										<textarea id="editor_id" name="sendContent" class="editor" cols="42" rows="11" style="width:630px;hight=215px">
										</textarea>
									</td>
								</tr>
								<tr class="btncenter">
					...
					<div class="tab-pane" id="imgsTab">
						<table>
							...
							<tr><td>
								...
								<input type='button' onClick='selectNews()' class='btn btn-warning btmimgbtn' name='del' id='buttondel' value='选择多图文素材' style="width:140px"/> 													
							</td></tr>
							</form>
						</table>
					</div>			
	...
	<script language='javascript'>
		...
		function saveTxt() {
			...
			xmlHttp.open("GET","<?php echo constant("CONF_THEME_DIR");?>/wechat/keyword/add_keyword_txt.php?keyword="+keyword+"&content="+escape(document.getElementById('editor_id').value), true);
		...
		function selectNews(){
			var keywordId=null;
			var keyword=$("#addedKeyWord").val();
			window.open("keyword_news_list_dlg.php?keywordId="+keywordId+"&keyword="+keyword,"_blank","height=520,width=800,top=120,left=240,toolbar=no,menubar=no,scrollbars=yes,resizable=no,location=no,status=no,titlebar=no");
		}
