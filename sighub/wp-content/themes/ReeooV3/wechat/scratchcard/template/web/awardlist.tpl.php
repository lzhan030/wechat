...
<div class="main_auto">
	<div class="main-title">
		<div class="title-1">当前位置：<a href="<?php echo $this->createWebUrl('scratchcardlist',array());?>">刮刮卡</a> > <font class="fontpurple">刮刮卡中奖详情</font></div>
	</div>
		...
		<div class="stat">
			<div class="stat-div">
				...
				<div class="sub-item">
					...
					<input type="hidden" name="module" value="scratchcard" />
					<input type="hidden" name="do" value="awardlist" />
					<input type="hidden" name="name" value="scratchcard" />
