    ...
    <body>
		<div>
			<div class="mobile-div img-rounded">
			    <div class="mobile-hd">微作业 > <font class="fontpurple">上传作业</font></div>
				<div class="mobile-content">
					...
					<!--<input type="button" class="btn btn-info" onclick="location.href='<?php //echo $this->createMobileUrl('AddHomework',array('GWEID' => $gweid,'fromuser'=>$fromuser));?>'" value="新建作业" style="position:relative; margin-right:5%; border-radius:6px;"/>-->
					<input type="button" class="btn btn-info" onclick="location.href='<?php echo $this->createMobileUrl('AddHomework',array('gweid' => $gweid));?>'" value="新建作业" style="position:relative; margin-right:5%; border-radius:6px;"/>
					</div>
			    </div>
			</div>
...
/*else if(($fromuser==null)&&(!$countstea)){
