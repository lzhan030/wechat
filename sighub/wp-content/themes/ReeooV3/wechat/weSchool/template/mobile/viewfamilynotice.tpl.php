...
<?php //echo $htmlData; ?>
	...
	<div class="mobile-hd">微公告 > <font class="fontpurple">家长公告 </font></div>
	
	<div class="mobile-content">
	<h4>标题：<?php echo $notice_title ?></h4>
		<?php if($notice_allowcomments==1){ ?>
			<!--<i><a style="font-size:20px;" href="<?php //echo $this->createMobileUrl('replyfamilylist',array('GWEID' => $gweid,'fromuser'=>$fromuser,'noticeId'=>$notice_id));?>">评论</a></i>-->
			<i><a style="font-size:20px;" href="<?php echo $this->createMobileUrl('replyfamilylist',array('gweid' => $gweid,'noticeId'=>$notice_id));?>">评论</a></i>
		<?php } ?>
	</div>
	</div>
  <!--测试-->
