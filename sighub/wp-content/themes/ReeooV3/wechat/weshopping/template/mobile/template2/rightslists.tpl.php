...
<html>
		...
		<div class="mobile-content">
			...
			<div style="float:right;">
				...
				<div style="float:left;">
					<a style="" onclick="location.href='<?php echo $this->createMobileUrl('rightsorderstatus',array('gweid' => $gweid,'out_trade_no' => $rsinfo['out_trade_no'],'feedbackid' => $rsinfo['feedbackid'],'goodsgid'=>$goodsgid));?>'" >[维权详情]</a>  	
				</div>
			</div>
		</div>
	</div>	
  ...
  <div class="footerbar">
	<a style="width:33%;padding-top:15px" onclick="href='<?php echo $this->createMobileUrl('list',array('gweid'=>$gweid));?>'">首页</a>
	<a style="width:33%;padding-top:15px" onclick="href='<?php echo $this->createMobileUrl('myorder',array('gweid' => $gweid)); ?>'">我的订单</a>
