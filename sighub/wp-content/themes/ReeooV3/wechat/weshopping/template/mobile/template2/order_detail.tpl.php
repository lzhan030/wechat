...
<div id="top" style="margin-top: -45px;">
    <div class="header-title1">订单详情</div>
	<div class="site-nav">
		<ul class="fix">
...
<div class="myoder img-rounded">
	...
	<div class="myoder-detail">
		...
		<div class="pull-left">
			...
			<div class="price">
				<span style="width:100%"><?php  echo $g['market_price'];?> 元<?php  if($g['unit'] && ($g['ismanual'] == 0)) { ?> / <?php  echo $g['unit'];?><?php  } ?></span>
				<!-- point update -->
				<span style="width:100%;<?php if($g['point']!=0 && $g['ismanual'] !=1){ }else{?> display:none; <?php } ?>">
					<?php  echo $g['point'];?> 分<?php  if($g['unit'] && ($g['ismanual'] == 0)) { ?> / <?php  echo $g['unit'];?><?php  } ?><?php if($g['ispoint']!=0 && $g['ismanual']!= 1){ echo "(使用积分购买)"; } ?>
				</span>
				<!-- point update end-->
				<?php if($g['ismanual'] == 0){?><span class="num"><?php  echo $g['total'];?>  <?php  if($g['unit']) { ?> <?php  echo $g['unit'];?><?php  } ?></span><?php }?>
			</div>
		</div>
	</div>
	<?php  } } ?>
	...
	<div style='float:left;margin:10px;overflow:hidden;word-break:break-all;width:100%;'>
	   <pre style="border:none;background:#fff;font-family:'microsoft yahei',Verdana,Arial,Helvetica,sans-serif" class="mobile-content"><?php echo $remark;?></pre>
	</div>
	<?php  } ?>
	...
	<div style='float:left;margin:10px;overflow:hidden;word-break:break-all;width:100%;'>
	   <pre style="border:none;background:#fff;font-family:'microsoft yahei',Verdana,Arial,Helvetica,sans-serif" class="mobile-content"><?php echo $item['remark'];?></pre>
	</div>
	<?php  } ?>
	...
	<div class="myoder-total">
		...
		<a onClick="callpayconfirm('<?php echo $item['out_trade_no']; ?>',this)" class="btn btn-danger pull-right btn-sm">立即支付</a>
		<?php  } ?>
