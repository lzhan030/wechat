...
<ul class="nav nav-tabs">
	<li <?php  if($operation == 'display' && $status == '') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('order', array('op' => 'display'))?>">全部订单</a></li>
	<li <?php  if($operation == 'display' && $status == '1' && ( $sendtype=='1' || $sendtype=='0')) { ?> class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('order', array('op' => 'display', 'status' => 1))?>">待发货</a></li>
	<li <?php  if($operation == 'display' && $status == '1' && $sendtype == '2') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('order', array('op' => 'display', 'status' => '1', 'sendtype' => 2))?>">待自提</a></li>
	...
	<!--				<th style="width:50px;">类型</th>-->
				...
				<tbody>
					...
					<tr>
						...
						<td><?php  if($item['paytype'] == 2) { ?><span class="label label-info">在线支付</span><?php  } ?><?php  if($item['paytype'] == 3) { ?><span class="label label-warning">货到付款</span><?php  } ?></td>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<p class="form-control-static"><?php  echo $item['user']['qq'];?></p>
					</div>
				</div>
				<div class="form-group">
			...
			<div class="panel-body table-responsive">
				<table class="table table-hover">
					...
					<tr>
						...
						<td><?php  if($goods['status']==0) { ?><span class="label label-success">上架</span><?php  } else { ?><span class="label label-error">下架</span><?php  } ?>&nbsp;<span class="label label-info"><?php  if($goods['type'] == 1) { ?>实体商品<?php  } else { ?>虚拟商品<?php  } ?></span></td>
