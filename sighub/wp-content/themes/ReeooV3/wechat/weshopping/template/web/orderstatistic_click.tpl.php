...
<script type="text/javascript" src="<?php bloginfo('template_directory'); ?>/js/calendar.js"></script>
	...
	<!--主体-标题-->
		<div class="main-title">
			...
			<a href="<?php echo $this->createWebUrl('indexstatistic',array('gweid' => $gweid));?>">统计图表</a> > <font class="fontpurple">流量统计 </font></div>
		</div>
		...
		<!--statistic new add-->
		<div id="div7" style="margin-left:370px;margin-top:45px; margin-bottom:-30px; display:none;">商品总点击量</div>
		...
		<div id="div6" style="margin-left:370px;margin-top:45px; margin-bottom:-30px; display:none;">综合分析商品点击量</div>
