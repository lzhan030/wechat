...
?> 
<link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/../ReeooV3/css/video-js.min.css">
<!-- 加载 VideoJS js -->
<script src="<?php bloginfo('template_directory'); ?>/../ReeooV3/js/videojs/video.js" type="text/javascript" charset="utf-8"></script>

<!-- 皮肤 -->
<link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/../ReeooV3/css/video-js.min.css" type="text/css" media="screen" title="Video JS">
 <script>
                                    ...
                                    <?php while(have_posts()) : the_post(); ?>
                                        ...
                                        <div class="post" id="post-<?php the_ID(); ?>">
                                            ...
                                            <div class="title">
                                              ...
                                              <div class="content"><?php $videourl=$wpdb->get_var($wpdb->prepare("SELECT url FROM {$wpdb->prefix}video WHERE persistentId = %s",theme_get_post_content(get_the_content())));/*the_content();*/ ?>
