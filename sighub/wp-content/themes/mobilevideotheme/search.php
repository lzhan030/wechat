            ...
            <?php if($post->post_content_filtered ==  $siteId){
                ...
                <div class="post" id="post-<?php the_ID(); ?>">
					...
					<div class="title"><!--janeen-update-20140429-->
                        <h2><a href="<?php the_permalink(); echo '&site='.$siteId.'&gweid='.$gweidt; ?>#wechat_redirect" title="<?php the_title(); ?>"><font><?php the_title();?> </font></a></h2>
                    </div>
					
					<div class="date"><?php //echo $post_content_length;?>       <?php if($isShowPic=='false'){ the_author()?>
                        发布于 <?php the_time('F j, Y');} ?>
                    </div>
