...
case 'all':
?>	
	location.href='?admin&page=groupmanage&Ipad='+idat+'&range='+rang;
<?php
break;
case 'group_name':
?>	
	location.href='?admin&page=groupmanage&Ipad='+idat+'&flag='+flag+'&range='+rang;
<?php
break;
case 'display_name':
?>	
...
default:
?>
    location.href='?admin&page=groupmanage&Ipad='+idat;
<?php
} 
?>
</script>